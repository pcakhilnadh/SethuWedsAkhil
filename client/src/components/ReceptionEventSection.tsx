...
export function ReceptionEventSection() {
  ...
  return (
    <section id="reception" className="py-12 sm:py-16 lg:py-20 relative overflow-hidden">
      {/* Subtle warm background */}
      <div className="absolute inset-0 bg-gradient-to-b from-stone-50 via-amber-50/30 to-stone-50" />
        ...
        >
          ...
          <div className="bg-white rounded-2xl shadow-[0_8px_40px_-12px_rgba(0,0,0,0.15)] overflow-hidden border border-stone-100">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="relative bg-gradient-to-br from-amber-600 via-orange-600 to-amber-700 p-8 lg:p-10 flex flex-col justify-between min-h-[400px]">
                {/* Decorative elements */}
                ...
                <motion.a
                  ...
                  className="relative z-10 mt-8 inline-flex items-center justify-center gap-3 bg-white text-amber-700 rounded-xl px-6 py-4 font-semibold text-base shadow-lg hover:shadow-xl transition-all duration-300 group"
                >
              ...
              <div className="p-8 lg:p-10 flex flex-col justify-between bg-white">
                {/* Invitation Message */}
                <div className="mb-8">
                  <p className="text-stone-600 text-base sm:text-lg leading-relaxed font-light italic border-l-4 border-amber-200 pl-4">
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="bg-stone-50 rounded-xl p-4 text-center border border-stone-100">
                    ...
                    <p className="text-sm font-semibold text-stone-800">{reception.date}</p>
                  </div>
                  ...
                  <div className="bg-stone-50 rounded-xl p-4 text-center border border-stone-100">
                    ...
                    <p className="text-sm font-semibold text-stone-800">{reception.time}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <motion.button
                    ...
                    className="flex items-center justify-center gap-2 bg-amber-600 text-white rounded-xl px-4 py-3.5 font-medium text-sm hover:bg-amber-700 transition-colors"
                  >
